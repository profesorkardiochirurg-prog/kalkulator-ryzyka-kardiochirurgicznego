...
(function () {
  const I18N = {
    pl: {
      // dokumenty
      "doc.title": "CARMA — Kalkulator ryzyka kardiochirurgicznego (śmiertelność operacyjna)",
      "doc.desc": "CARMA — kalkulator ryzyka śmiertelności operacyjnej po operacji kardiochirurgicznej. Uniwersalny model uczenia maszynowego na danych KROK (AUC 0,809, bije EuroSCORE II). Wyłącznie do celów badawczych.",
      ...
      // hero kalkulatora
      "hero.title": "Kalkulator ryzyka śmiertelności operacyjnej",
      ...
      "badge.auc": "AUC 0,809",
      "badge.euro": "EuroSCORE II: 0,776",
      "badge.universal": "Uniwersalny — jak EuroSCORE II",
      "badge.n": "296 514 operacji · 2012–2024",
      ...
      // wynik
      "res.cap": "ryzyko zgonu operacyjnego",
      ...
      // stopka kalkulatora
      "foot.train": `<strong>Dane treningowe</strong><br/>296 514 operacji kardiochirurgicznych u dorosłych (KROK, 2012–2024).`,
      "foot.valid": `<strong>Walidacja punktu końcowego</strong><br/>Zgon operacyjny (w szpitalu lub w ciągu 30 dni) zweryfikowany wobec rejestru zgonów Ministerstwa Zdrowia (PESEL).`,
      ...
      "a.about.body": `<strong>CARMA</strong> (CARdiac surgery Mortality Assessment) to kalkulator powstały w ramach projektu badawczego wykorzystującego dane <strong>Krajowego Rejestru Operacji Kardiochirurgicznych (KROK)</strong>. Model uczenia maszynowego (gradient boosting) przewiduje śmiertelność operacyjną po operacji kardiochirurgicznej u dorosłych i w walidacji czasowej osiąga <strong>AUC 0,809</strong> wobec 0,776 dla EuroSCORE II. Punkt końcowy zweryfikowano wobec rejestru zgonów Ministerstwa Zdrowia (PESEL). Celem projektu jest dostarczenie precyzyjnego, niezależnego narzędzia oceny ryzyka opartego na rzeczywistych polskich danych klinicznych.`,
      "a.authors": "Autorzy",
    ...
    en: {
      "doc.title": "CARMA — Cardiac Surgery Risk Calculator (operative mortality)",
      "doc.desc": "CARMA — calculator of operative mortality risk after cardiac surgery. Universal machine-learning model on KROK data (AUC 0.809, beats EuroSCORE II). For research purposes only.",
      ...
      "hero.title": "Operative Mortality Risk Calculator",
      ...
      "badge.n": "296,514 operations · 2012–2024",
      ...
      "foot.train": `<strong>Training data</strong><br/>296,514 adult cardiac surgery operations (KROK, 2012–2024).`,
      "foot.valid": `<strong>Endpoint validation</strong><br/>Operative death (in-hospital or within 30 days) verified against the Ministry of Health mortality registry (PESEL).`,
      ...
      "a.about.body": `<strong>CARMA</strong> (CARdiac surgery Mortality Assessment) is a calculator developed within a research project using data from the <strong>Polish National Registry of Cardiac Surgery Procedures (KROK)</strong>. The machine-learning model (gradient boosting) predicts operative mortality after adult cardiac surgery and, in temporal validation, reaches <strong>AUC 0.809</strong> versus 0.776 for EuroSCORE II. The endpoint was verified against the Ministry of Health mortality registry (PESEL). The project's goal is to provide a precise, independent risk-assessment tool based on real Polish clinical data.`,
      "a.authors": "Authors",
